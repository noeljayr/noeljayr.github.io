    ...
    animations: [
      {
        elements: {
          eN4np3tT1Do2: {
            transform: {
              data: {
                o: { x: 178.25, y: 18.25001, type: "corner" },
                t: { x: -178.25, y: -18.25001 },
              },
              keys: {
                r: [
                  { t: 500, v: -111 },
          ...
          eN4np3tT1Do4: {
            transform: {
              data: {
                o: { x: 95.499775, y: 34.499998, type: "corner" },
                t: { x: -95.499775, y: -34.499998 },
              },
              keys: {
                r: [
                  { t: 700, v: -45 },
          ...
          eN4np3tT1Do7: {
            transform: {
              data: { t: { x: -155.75, y: -94 } },
              keys: {
                o: [
                  { t: 0, v: { x: 43.89941, y: 124.774932, type: "corner" } },
                  {
                    t: 1100,
                    v: { x: 73.530957, y: 69.779056, type: "corner" },
                  },
                ],
              },
            },
          ...
          eN4np3tT1Do9: {
            transform: {
              data: { t: { x: -90.352226, y: -126.729923 } },
              keys: {
                o: [
                  { t: 0, v: { x: 90.352227, y: 126.729924, type: "corner" } },
                  { t: 500, v: { x: 72.336052, y: 109, type: "corner" } },
                  {
                    t: 1000,
                    v: {
                      x: 90.352227,
                      y: 126.729924,
                      type: "corner",
                      start: { x: 90.352227, y: 126.729924 },
                      end: { x: 90.352227, y: 126.729924 },
                    },
                  },
                ],
              },
        ...
        s: "",
      },
    ],
    options: "MUDAxMDg4UDJmODA4MUKs2ZTdmODEyZjQ3MmYY3OTdjNmU3MUYyZjhhB",
  },
  "__SVGATOR_PLAYER__",
  window,
  document
